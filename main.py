# main.py - VERSION CON SUBIDA A DRIVE HABILITADA
import os
import sys
import json
import shutil
...
def upload_to_drive(html_file, audio_files=None):
    ...
    try:
        ...
        # 1. Subir HTML del día (desde la raíz o historial)
        ...
        if os.path.exists("index.html"):
            ...
            print("⚠️ index.html no encontrado para subir", flush=True)
        ...
        if os.path.exists("resumen_cooperativo.mp3"):
            ...
            print("⚠️ resumen_cooperativo.mp3 no encontrado", flush=True)
        ...
        # 6. Subir índice de temas si existe
    ...
    try:
        ...
        if total_news == 0:
            ...
            if html_file:
                ...
                # Subir a Drive incluso sin noticias
        ...
        # ============================================
        # PASO 4: GENERAR HTML Y AUDIOS
        # ============================================
        print("\n📄 PASO 4: Generando boletin HTML y audios...", flush=True)
        ...
        # ============================================
        print("\n☁️ PASO 6: Subiendo a Google Drive...", flush=True)
        ...
        # ============================================
        # PASO 7: LIMPIAR HISTORICO
        # ============================================
        print(f"\n🗑️ PASO 7: Limpiando historico (manteniendo {MAX_HISTORY_DAYS} dias)...", flush=True)
        cleanup_old_history()
