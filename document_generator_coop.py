# document_generator_coop.py - CON LOGO, CTA, LISTADO, VISUALIZACIÓN DE CONTEXTO Y AUDIO PARA TODOS LOS PAÍSES
import json
import os
import shutil
...
<body>
    ...
    for code in country_codes:
        ...
        if has_news:
            ...
            """
            # 🔥 INCLUSO EN CONTEXTO, MOSTRAMOS EL AUDIO SI EXISTE
            if country_audio_url:
                html_content += f"""
                    <div class="audio-player">
                        <span>🎧 Escuchar resumen de {country}:</span>
