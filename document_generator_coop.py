# document_generator_coop.py - CON SOPORTE PARA LOGO
import json
import os
import shutil
...
# 🔥 CONFIGURACIÓN DEL LOGO - CAMBIAR SEGÚN LA OPCIÓN ELEGIDA
LOGO_FILE = "logo-ia-coop-lab.png"  # Opción 1: Archivo local
# LOGO_URL = "https://ejemplo.com/logo-ia-coop-lab.png"  # Opción 2: URL externa
# LOGO_BASE64 = "data:image/png;base64,..."  # Opción 3: Base64
...
def get_logo_html() -> str:
    ...
    if os.path.exists(LOGO_FILE):
        return f'<img src="{LOGO_FILE}" alt="IA-COOP-LAB" style="height: 60px; width: auto; margin-right: 15px;">'
    
    # Opción 2: URL externa
    if 'LOGO_URL' in globals():
        return f'<img src="{LOGO_URL}" alt="IA-COOP-LAB" style="height: 60px; width: auto; margin-right: 15px;">'
    
    # Opción 3: Base64 (descomentar y usar)
    # if 'LOGO_BASE64' in globals():
    #     return f'<img src="{LOGO_BASE64}" alt="IA-COOP-LAB" style="height: 60px; width: auto; margin-right: 15px;">'
    
    # Fallback: Logo en texto si no hay imagen
    return """
    <div style="display: flex; align-items: center; justify-content: center; gap: 15px; margin-bottom: 10px;">
        <div style="background: linear-gradient(135deg, #1a365d, #2b6cb0); 
            ...
            <span style="font-size: 2rem; color: white; font-weight: bold;">IA</span>
        </div>
        <div style="text-align: left;">
            <div style="font-size: 1.8rem; font-weight: bold; color: #1a365d; letter-spacing: 2px;">
                IA-COOP-LAB
            </div>
            <div style="font-size: 0.8rem; color: #2b6cb0; letter-spacing: 1px;">
...
def generate_cooperative_html(summaries: Dict, output_filename="index.html") -> str:
    """Genera el HTML del boletin cooperativo con IA-COOP-LAB y logo"""
