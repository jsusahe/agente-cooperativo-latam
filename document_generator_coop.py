# document_generator_coop.py - CON LOGO, CTA, LISTADO, CONTEXTO Y CTA FINAL DE SUSCRIPCIÓN
import json
import os
import shutil
...
def generate_history_list() -> str:
    ...
    # URL base para GitHub Pages (ajusta según tu repositorio)
...
def generate_cooperative_html(summaries: Dict, output_filename="index.html") -> str:
    ...
    # 🔥 CTA final fijo
    cta_html = """
    <div style="margin-top: 30px; text-align: center; background: linear-gradient(135deg, #1a365d, #2b6cb0); color: white; padding: 25px; border-radius: 15px; box-shadow: 0 4px 10px rgba(0,0,0,0.2);">
        <h3 style="margin-bottom: 10px; font-size: 1.8rem;">🚀 IA-COOP-LAB</h3>
        <p style="font-size: 1.1rem; margin-bottom: 20px;">Transforma tu cooperativa con Inteligencia Artificial. Formación, metodología y herramientas para el sector cooperativo.</p>
        <a href="https://www.cygnuscooperativo.com/iacooplab" target="_blank" style="display: inline-block; background: #ed8936; color: white; padding: 12px 30px; border-radius: 30px; text-decoration: none; font-weight: bold; font-size: 1.1rem; transition: background 0.3s;">🔗 Conoce más y suscríbete</a>
        <p style="margin-top: 15px; font-size: 0.9rem; opacity: 0.8;">Inteligencia Artificial para el Cooperativismo Latinoamericano</p>
    </div>
    """
...
<head>
    ...
    <style>
        * {{ margin: 0; padding: 0; box-sizing: border-box; }}
        ...
        .audio-player audio {{ flex: 1; min-width: 200px; width: 100%; }}
        ...
        .regional-section h2 {{ color: #744210; margin-bottom: 15px; display: flex; align-items: center; gap: 10px; flex-wrap: wrap; }}
        ...
        @media (max-width: 768px) {{
            ...
            .country-meta {{ margin-left: 0; width: 100%; text-align: center; }}
            .scroll-top {{
                bottom: 15px;
                right: 15px;
                width: 35px;
    ...
    <div class="container">
        ...
        <div class="tip-section">
            ...
            <div class="tip-content">
                <h3 style="color: #744210; word-wrap: break-word;">{tip_title}</h3>
                <p style="word-wrap: break-word;">{tip_text}</p>
            </div>
            ...
            <div style="margin-top: 15px; text-align: center; background: rgba(255,255,255,0.6); padding: 10px; border-radius: 8px; border: 2px solid #dd6b20;">
                ...
                <p style="margin: 5px 0 0 0; font-size: 0.9rem; word-wrap: break-word;">
    ...
    for code in country_codes:
        ...
        if has_news:
            ...
            html_content += f"""
                ...
                <div style="margin-top: 10px; font-size: 0.9rem; color: #718096; display: flex; gap: 5px; align-items: center; flex-wrap: wrap;">
    ...
    html_content += f"""
        ...
        <div class="footer">
            ...
            <p style="font-size: 0.8rem; margin-top: 10px;">
                Fuentes: Superintendencias, Confederaciones, Federaciones, Fondos de Empleados, medios especializados y redes sociales
            </p>
        </div>
    </div>
