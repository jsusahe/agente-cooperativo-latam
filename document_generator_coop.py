# document_generator_coop.py - CON LOGO A LA IZQUIERDA Y DOBLE TAMAÑO
import json
import os
import shutil
...
def get_logo_html() -> str:
    ...
    """
    # 🔥 Tamaño: 120px en lugar de 60px (el doble)
    ...
    # Fallback: Logo en texto (también más grande)
    return """
...
def generate_cooperative_html(summaries: Dict, output_filename="index.html") -> str:
    ...
    # 🔥 Obtener el logo HTML (ahora a la izquierda y doble tamaño)
