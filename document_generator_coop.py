# document_generator_coop.py - CON BANDERAS MEJORADAS (SVG + EMOJI FALLBACK)
import json
import os
import shutil
...
def get_flag_html(country_code: str, country_name: str) -> str:
    ...
    """
    # 🔥 Mapeo de códigos a URLs de banderas (CDN confiable)
    flag_urls = {
...
<body>
    ...
    # 🔥 Procesar cada país con su bandera (versión mejorada)
