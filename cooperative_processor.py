...
import json
import os
import re  # ⬅️ ¡AGREGAR ESTA LÍNEA!
...
class CooperativeProcessor:
    ...
    def process_country_news(self, country_data: Dict) -> Dict:
        ...
        for article in articles:
            ...
            # Limpiar resumen - AHORA 're' ESTÁ IMPORTADO
    ...
    def select_news_for_summary(self, articles: List[Dict], grouped: Dict) -> List[Dict]:
        ...
        priority_order = [
            'supervision', 'national_association', 
        ...
        for category in priority_order:
            if category in grouped and grouped[category]:
                sorted_news = sorted(grouped[category], 
        ...
        if remaining_slots > 0:
            ...
            all_remaining.sort(key=lambda x: x.get('published', datetime.now()), reverse=True)
