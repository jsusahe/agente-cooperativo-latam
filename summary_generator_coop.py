# summary_generator_coop.py - VERSIÓN COMPLETA CON INTEGRACIÓN DE PDF
import json
import requests
import os
import re
...
class CooperativeSummaryGenerator:
    ...
    def generate_coop_tip(self) -> Dict:
        ...
        # 🔥 Si no se pudo cargar el PDF, usar el prompt genérico
        if not self.pdf_context:
            ...
            Si el documento menciona ejemplos (como los de la Cooperativa Integral "El Valle"), úsalos como referencia.
