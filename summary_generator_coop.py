# summary_generator_coop.py - VERSIÓN COMPLETA CON GENERACIÓN DE CONTEXTO POR PAÍS Y REGIONAL EN ESPAÑOL
import json
import requests
import os
import re
...
class CooperativeSummaryGenerator:
    ...
    def generate_regional_summary(self, all_countries: Dict) -> Dict:
        ...
        # 🔥 SISTEMA PROMPT CORREGIDO: Totalmente en español y forzando el idioma
        system_prompt = """
